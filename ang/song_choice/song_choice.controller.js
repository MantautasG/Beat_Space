(function () {
   // 'use strict';
    ...
    function SongChoiceController($location, AuthenticationService, $rootScope, FlashService, UniversalService, $scope, $sce) {
        ...
        vm.albumimg = null;
        vm.artistimg = null;  
        vm.artistdescription = null;
        vm.albumdescription = null;
        vm.allgenres = [];
        vm.submit = submit;
        ...
        function submit() {      
            debugger;
            if (vm.Url.indexOf("&") !=-1) {
                    vm.Url = vm.Url.substr(0,vm.Url.indexOf('&'));
                }
            ...
            var JSONObject = {
                 ...
                 "ArtistDescription": vm.artistDescription,
                 "AlbumDescription": vm.albumdescription
                 };

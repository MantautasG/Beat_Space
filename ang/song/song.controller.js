(function () {
    ...
    function SongController($location, AuthenticationService, $rootScope, FlashService, UniversalService, $scope, $sce) {
        ...
        function loadAllSongs() {   
            UniversalService.GetAlbumById().then(function (album){
                debugger;
                vm.album = album.Results;
            });
        ...
        $scope.currentSong = function(url, id, artistName, songName) {
            vm.currentId = id;
            debugger;
                if (url.indexOf("&") !=-1) {

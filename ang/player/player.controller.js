    ...
    function PlayerController($location, AuthenticationService, $rootScope, FlashService, UniversalService, $scope, $sce) {
        ...
        $scope.nextSong = function() {
            ...
            UniversalService.GetOneSongById(next).then(function (song) {
                ...
                vm.PlayerUrl = $sce.trustAsResourceUrl(Url + '?enablejsapi=1&modestbranding=1&showinfo=0&controls=0&autoplay=1&vq=hd1080&modestbranding=1&rel=0&iv_load_policy=3');
                UniversalService.GetArtistById(song.Results.ArtistId)
                .then(function (artist) {
                    ...
                    Player: {
                        ...
                        songName: song.Results.Name,
                        artistName: artist.Results.Name
                        }
                    };
                });
